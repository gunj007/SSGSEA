logv=read.csv("C:/Users/GUNJAN/OneDrive/Documents/machinelearning/log_values.csv")
...
# data[1:5,1:5]
data = as.matrix(data)
gene_set = read.csv("C:/Users/GUNJAN/OneDrive/Documents/machinelearning/markers2Sep.csv")
head(gene_set)
gene_sets = as.list(as.data.frame(gene_set))
print("genes set ready")


res=ssgsea(as.matrix(data), gene_sets, scale = FALSE, norm = FALSE)
res1 = t(res)
head(res1)
